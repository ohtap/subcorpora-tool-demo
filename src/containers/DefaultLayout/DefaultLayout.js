...
const Keyword_Lists = loadable(() => import('../Keyword_Lists'));
const Collections = loadable(() => import('../Collections'));
const Past_Runs = loadable(() => import('../Past_Runs'));
const Create_Run = loadable(() => import('../Create_Run'));
      ...
      <div className={classes.root}>
        ...
        >
          <div className={classes.drawerHeader} />
            ...
            <Route exact path='/keyword_lists' component={Keyword_Lists} />
            <Route exact path='/collections' component={Collections} />
            <Route exact path='/create_run' component={Create_Run} />
            <Route exact path='/past_runs' component={Past_Runs} />
            <Route exact path='/sample_report' component={Report} />
        </main>
        </BrowserRouter>
      </div>
    );
